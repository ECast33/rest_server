module.exports = {
    ...
    ISSUER: process.env.OIDC_ISSUER || 'http://qa.designinteractive.net:8005/auth/realms/auth-gateway-app',
    CLIENT_ID: process.env.OIDC_CLIENT_ID || 'auth-gateway-app',
    ...
    FRONTEND_CALLBACK_URL: process.env.FRONTEND_CALLBACK_URL || 'http://localhost:8000/api/v1/auth/callback',
